...
namespace Peo.Billing.Infra.Data.Helpers
{
    public static class BillingDbMigrationHelpers
    {
        public static async Task UseBillingDbMigrationHelperAsync(this WebApplication app)
        {
